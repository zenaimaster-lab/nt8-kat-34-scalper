...
namespace NinjaTrader.NinjaScript.Indicators.KAT
{
	public class KatSignalA1 : Indicator
	{
		...
		private void EvaluateAlertA1Bar()
		{
			...
			int dir = Kat34ScalperLogic.A1DebouncedDir(rawDir, a1LastDir, a1InvalidStreak, BreakBars);
			...
			bool fired = Kat34ScalperLogic.A1EdgeStep(rawDir, a1LastDir, a1InvalidStreak, BreakBars, out a1LastDir, out a1InvalidStreak);
			if (fired)
			{
